...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC © 𝐑𝐞𝐠𝐚 𝐞𝐱𝐞𝐜𝐮𝐭𝐞𝐝`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: m })} 
//=================================================//
try {
...
break
case 'jadikatalog': case 'regakatalog': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC © °𝐑𝐞𝐠𝐚 𝐞𝐱𝐞𝐜𝐮𝐭𝐞𝐝°͢`,"body": `Selamat ${salam} kak ${pushname}`,
...
break
//=================================================//
case 'regatroli2': case 'regatrol': case 'jutrol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'regatroli3': case 'regatrol2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
for (let i = 0; i < jumlah; i++) {
 ...
 break
//=================================================//
case 'regadocu': case 'regadraknes':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'duc': case 'regaslebew': case 'cumadocu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'regavirtext1': case 'regazsu': case 'crashar1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'regavirtext2': case 'regatol': case 'crashar2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'regavirtext3': case 'regamemek': case 'crashar3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'regavirtext4': case 'regacontol': case 'crashar4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'regavirtext5': case 'regatextv': case 'crashar5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'regavirtext6': case 'regagas': case 'crashar6':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'regavirtext7': case 'regavirtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'regavirtext8': case 'regavirtext1': case 'crashar7':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'regavirtext9': case 'regavirtext2': case 'crashar8':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'regavirtext10': case 'regavirtext3': case 'crashar9': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'regabug1': case 'regacrash': case 'crashar10':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'regabug2': case 'regacrash1': case 'crashar11': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
{ quickReplyButton: { displayText: `HAIKAL`, id: `JAGOAN OM?`}},
 ...
 break
//=================================================//
case 'regabug3': case 'regacrash2': case 'crashar12': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'regabug4': case 'regacrash3': case 'crashar13':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'regabug5': case 'regacrash4': case 'crashar14': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case 'regabug6': case 'regacrash5': case 'crashar15':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'regabug7': case 'regacrash6': case 'crashar16':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'regabug8': case 'regacrash7': case 'crashar17': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case '🌷': case 'crashmek': case 'ampunsuhu': case 'ahyangbetul': case 'okemek': case 'reganih': case 'crashar18': case 'mexdemam': case 'rega1': case 'rega2': case 'rega3': case 'rega4': case 'rega5': case 'rega6': case 'rega7': case 'rega8': case 'rega9': case 'rega10': case 'rega11': case 'rega12': case 'rega13': case 'rega14': case 'rega15': case 'rega16': case 'rega17': case 'rega18': case 'rega19': case 'rega20': case 'rega21': case 'rega22': case 'rega23': case 'rega24': case 'rega25': case 'rega26': case 'rega27': case 'rega28':
case 'rega29':
case 'rega30':
case 'rega31':
case 'rega32':
...
break
//=================================================//
case 'regastik': case 'regakangbug': case 'buttonkematian': case 'crashar19': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'regabugie': case 'regakangbug1': case 'crashar20': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'regabutton': case 'regakangbuttton': case 'testbutton': case 'inibutton': 
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'regabokep': case 'regangentod': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
┗━━⊱
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
© °rega°͢`, contextInfo:{"externalAdReply": {"title": `SC °𝐑𝐞𝐠𝐚 𝐞𝐱𝐞𝐜𝐮𝐭𝐞𝐝°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
┣❏afk { kasih reactions }
┣❏regaghoib [ on / off ]
┣❏regajagoan [ reply target ]
┣❏regasange [ Harus Menjadi Admin ]
...
┣❏crashmex 628xxx|5|5
┣❏regaskuy 628xxx
┣❏regasantet 628xxx@s.whatsapp.net|10|10s
┣❏catalogpc 628xxx@s.whatsapp.net|10|10s
┗━━⊱[°rega°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Ketik > m.chat ( di group dulu )
┏━━⊱[ GROUP ]
┣❏gasrega 112674448xxx
┣❏regasantetgc  1237891xxxx@g.us|10|10s
...
┗━━⊱[°rega°]`,
contextInfo:{"externalAdReply": {"title": `SC °𝐑𝐞𝐠𝐚 𝐞𝐱𝐞𝐜𝐮𝐭𝐞𝐝°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
┣❏rexjusound161
┗━━⊱[ © °rexju°]`,
contextInfo:{"externalAdReply": {"title": `SC © °𝐑𝐞𝐠𝐚 𝐞𝐱𝐞𝐜𝐮𝐭𝐞𝐝`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
